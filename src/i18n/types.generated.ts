 ...
 * 생성 시간: 2026-02-01T16:57:56.424Z
 * 총 키 개수: 1364
 */
...
/**
 * globalSearch 네임스페이스 키
 */
export type GlobalSearchKeys =
  | 'close'
  | 'description'
  | 'hint'
  | 'navigate'
...
export type SessionKeys =
  | 'actualId'
  | 'board.blockContaining'
  | 'board.clickToFilter'
  | 'board.clickToFilter.docs'
  | 'board.clickToFilter.edits'
  | 'board.clickToFilter.fileOperations'
  | 'board.clickToFilter.filesCreated'
  | 'board.clickToFilter.git'
  | 'board.clickToFilter.mcp'
  | 'board.clickToFilter.reads'
  | 'board.clickToFilter.search'
  | 'board.clickToFilter.shell'
  | 'board.clickToFilter.web'
  | 'board.codeSearch'
  | 'board.controls.all'
  | 'board.controls.command'
  | 'board.controls.file'
  | 'board.dragToPan'
  | 'board.controls.mcp'
  | 'board.controls.model'
  | 'board.controls.pixelView'
  | 'board.controls.readView'
  | 'board.controls.skimView'
  | 'board.controls.status'
  | 'board.controls.tool'
  | 'board.docUpdates'
  | 'board.empty.description'
  | 'board.empty.title'
  | 'board.error.loadBoard'
  | 'board.errorDetected'
  | 'board.fileOperations'
  | 'board.filesCreated'
  | 'board.filesRead'
  | 'board.filesTouched'
  | 'board.gitCommits'
  ...
  | 'interaction.cancelledByUser'
  | 'interaction.containsLinks'
  | 'interaction.cutoff'
  | 'interaction.cutoffTitle'
  | 'interaction.docs'
  | 'interaction.documentationEdit'
  | 'interaction.duration'
  | 'interaction.edit'
  | 'interaction.errorDetected'
  | 'interaction.errorDetectedIcon'
  | 'interaction.exit'
  | 'interaction.exitCode'
  | 'interaction.fileEdit'
  | 'interaction.generalPurpose'
  | 'interaction.gitCommit'
  | 'interaction.gitOperation'
  | 'interaction.inputTokens'
  | 'interaction.markdownFileEdit'
  | 'interaction.markdownModified'
  | 'interaction.mdFileEditClick'
  | 'interaction.mcpInteraction'
  | 'interaction.messagesAndTokens'
  | 'interaction.openMessageFrom'
  | 'interaction.outputTokens'
  | 'interaction.userMessage'
  | 'interaction.verifiedCommit'
  | 'item.containsErrors'
  | 'item.containsToolUse'
  | 'item.lastModified'
  | 'item.messageCount'
  | 'item.session'
  | 'loading'
