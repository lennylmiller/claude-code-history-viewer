          ...
          {projects.length === 0 ? (
            ...
            <div className="space-y-0.5 animate-stagger">
              ...
              >
                ...
                >
                  <span title="Global Statistics"><Database className="w-4 h-4 transition-transform group-hover:scale-110" /></span>
                </div>
                ...
                return (
                  <div key={group.path} className="space-y-0.5">
                    ...
                    >
                      ...
                      >
                        {isGroupExpanded ? (
                          <span title={isGroupExpanded ? "Collapse" : "Expand"}><ChevronDown className="w-3.5 h-3.5" /></span>
                        ) : (
                          <span title={isGroupExpanded ? "Collapse" : "Expand"}><ChevronRight className="w-3.5 h-3.5" /></span>
                        )}
                      </span>
                      ...
                      >
                        <span title="Directory"><FolderTree className="w-3.5 h-3.5" /></span>
                      </div>
